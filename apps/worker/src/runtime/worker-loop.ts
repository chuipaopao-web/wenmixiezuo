...
export class WorkerLoop {
  ...
  private async tick(): Promise<void> {
    ...
    try {
      ...
      } else if (['chapter_creation', 'discussion', 'conversation_reply', 'continuation_analysis', 'volume_plan_generation', 'story_event_generation', 'event_chapter_sequence_generation', 'event_chapter_detail_generation'].includes(task.taskType) && this.chapterTasks !== undefined) {
