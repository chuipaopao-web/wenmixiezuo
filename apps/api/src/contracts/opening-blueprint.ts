...
const maleCategories: OpeningTaxonomyCategory[] = [
  ...
  ['male-urban-cultivation', '都市修真', '现代社会中的修真体系、身份冲突与成长', ['都市', '都市异能', '成长']],
...
const personalityGroups: OpeningPersonalityGroup[] = [
  {
    ...
    options: ['冷静', '沉稳', '热情', '温柔', '克制', '幽默', '毒舌', '疏离', '亲和', '骄傲', '叛逆', '慢热', '腹黑', '玩世不恭', '张扬', '内敛', '爽朗', '慵懒', '痞气', '呆萌']
  },
  {
    key: 'decision',
    name: '思考与决策',
    description: '角色遇到问题时怎样观察、判断和行动。',
    options: ['理性', '敏锐', '果断', '谨慎', '多疑', '冲动', '务实', '理想主义', '善于谋划', '随机应变', '执拗', '优柔寡断', '依赖直觉', '注重细节', '大局观强', '完美主义', '深思熟虑', '剑走偏锋']
  },
  {
    key: 'drive',
    name: '核心驱动力',
    description: '真正推动角色长期选择的内在需要。',
    options: ['野心勃勃', '责任感强', '渴望认可', '追求自由', '重视公平', '强烈求知欲', '保护欲强', '复仇心重', '害怕失去', '渴望归属', '守护承诺', '渴望力量', '只想躺平', '求生欲强', '渴望权力', '追求刺激', '执念深重', '爱财']
  },
  {
    key: 'relationship',
    name: '人际模式',
    description: '角色怎样信任、靠近、合作或对抗别人。',
    options: ['重情重义', '外冷内热', '嘴硬心软', '敢爱敢恨', '独来独往', '善于共情', '控制欲强', '讨好型', '难以交心', '慕强', '护短', '社牛', '社恐', '长袖善舞', '知恩图报', '乐于助人', '直来直去', '吃软不吃硬', '天生领头']
  },
  {
    key: 'pressure',
    name: '压力反应',
    description: '危险、失败和失控时会暴露的真实反应。',
    options: ['越挫越勇', '临危不乱', '逞强硬撑', '逃避拖延', '自我怀疑', '迁怒他人', '极端冒险', '反复复盘', '沉默封闭', '以笑掩饰', '先保全再反击', '宁折不弯', '情绪暴走', '爆发反击', '主动求助', '一蹶不振']
  },
  {
    key: 'moral',
    name: '道德边界',
    description: '角色愿意做什么、绝不会做什么，以及底线如何被考验。',
    options: ['善良有底线', '杀伐果断', '原则至上', '结果至上', '恩怨分明', '宽厚容人', '不择手段', '利益优先', '不伤无辜', '愿为大局牺牲', '绝不背叛', '底线会随代价动摇', '亦正亦邪', '蔑视规则', '以暴制暴', '只对自己人好']
  },
  {
    key: 'contradiction',
    name: '矛盾与成长面',
    description: '让人物不扁平的内外反差、缺点或潜在变化。',
    options: ['自信但怕失败', '强势却缺乏安全感', '善良但不敢拒绝', '聪明却过度自负', '嘴硬却容易心软', '理性却不懂表达', '渴望亲密又害怕依赖', '追求正义却手段激进', '习惯付出却不懂索取', '看似冷漠实则重情', '会从自保走向担当', '会从依赖走向独立', '天才却生活废柴', '被过去困住', '会从逃避走向面对', '会从冷漠走向温暖']
  }
];

export const OPENING_TAXONOMY: OpeningTaxonomy = {
  version: 'wenmi-single-category-subject-library-2026-08-19-v11',
