...
export const creativeMemberContracts: readonly CreativeMemberContract[] = [
  ...
  member('deputy_editor', '西施', '副编', '主编接管者和独立遗漏检查者', ['检查交接包', '租约失效时接管', '复核流程完整性'], ['租约有效时不并行发号施令'], ['任务检查点', '待决事项', '预算与调用状态'], ['交接报告', '接管建议'], 'standby', kimi),
  ...
  member('setting', '文姬', '设定', '维护世界规则、时间线和人物状态', ['连续性检查', '规则核对', '事实点评'], ['候选不自动升正史', '矛盾不静默覆盖'], ['结构化事实', '时间线', '规则', '关系状态'], ['连续性报告', '事实点评'], 'resident', glm),
