...
export const rolePromptDefinitions: readonly RolePromptDefinition[] = [
  {
    ...
    inputs: ['老板最新明确要求', '当前本书资料、设定大纲、正史版本和任务状态', '各岗位的结构化意见与证据', '预算、模型调用和Worker真实状态'],
  ...
  },
  {
    ...
    inputs: ['书籍定位和题材适配规则', '设定大纲、人物欲望与禁区', '已结算正史、未回收伏笔和当前章末状态', '主编给出的讨论范围和目标'],
  ...
  },
  {
    ...
    inputs: ['当前正史版本和设定大纲', '章节上下文包、章末状态和时间线', '候选设定及其来源状态', '待审正文或剧情方案'],
