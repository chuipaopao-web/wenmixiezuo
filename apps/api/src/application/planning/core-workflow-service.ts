...
import type {
  AuthorObjectDraftView, CharacterCardContent, CharacterCardView, CoreWorkflowStage, CoreWorkflowView,
...
export class CoreWorkflowService {
  ...
  public view(scope: BookScope): CoreWorkflowView {
    ...
    const ledgers = Object.fromEntries((['storyline','relationship','world_state','causality','foreshadow','settlement'] as CreativeLedgerType[])
      .map((ledgerType) => [ledgerType, { planned: [] as CreativeLedgerEntryView[], actual: [] as CreativeLedgerEntryView[] }])) as CoreWorkflowView['ledgers'];
  ...
  private storylineGrowth(scope: BookScope): CoreWorkflowView['growth'] {
