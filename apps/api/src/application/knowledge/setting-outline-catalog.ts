...
const CATALOG: Record<string, Metadata> = {
  ...
  'differentiator': item('作品策划', '差异化卖点', '与同类作品相比，哪些机制、视角或体验不可替代？'),
  'tone-boundary': item('作品策划', '作品气质与表达边界', '整体气质、叙事尺度与明确不能触碰的表达边界是什么？'),
  era: item('世界与环境', '时代与世界类型', '故事处于什么时代和世界类型，现实、架空或多世界如何并存？'),
  ...
  protagonist: item('人物与命名', '主角身份、起点与处境', '主角开始时拥有什么、缺少什么、处于怎样的社会位置？'),
  motivation: item('人物与命名', '核心欲望、动机与底线', '主角真正想要什么，害怕失去什么，哪些事绝不会做？'),
  ...
  'must-follow': item('约束、留白与未知', '必须遵守', '作者明确要求永远遵守的事实、尺度和禁区是什么？'),
  open: item('约束、留白与未知', '开放问题', '目前还没有答案、需要在后续创作中探索的问题是什么？'),
  'intentional-unknown': item('约束、留白与未知', '刻意留白', '哪些内容应保持未知，避免过早解释削弱悬念和创造性？'),
