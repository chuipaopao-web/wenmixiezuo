...
- **当前生效决定** — 本文只记录正在驱动当前版本的决定。 — `docs/DECISIONS.md` · 71.4 KB · `851ce6eb94ae`
...
- **文秘写作交接笔记（HANDOFF）** — 1. 设定页大改造（DEC-CURRENT-062，九条+质检补充全落地）：① 建书不再自动召集 AI，只做清单初始化，作者自己点"开始设计"。② 已确认设定可重新设计——迁移 0053 加待定候选四列，新方案先挂待定不动正稿，确认才转正、旧稿进历史，卡片显示"新方案待确认"，面板入口为醒目"重新设计"大按钮。③ 清空全部设定——页底入口+YES 确认，有正 — `HANDOFF.md` · 27.5 KB · `811ac5bfc684`
