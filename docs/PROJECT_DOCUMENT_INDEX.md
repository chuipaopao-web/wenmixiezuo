...
- **当前API与事件契约** — 确认开书会原子创建书籍、定位版本、团队、模型绑定、预算、设定工作区和首个设定任务。 — `docs/API.md` · 12.0 KB · `a639acfb5270`
...
- **长篇小说创作质量与工作流规范 V2** — 本规范用于保证长篇小说在持续创作中保持事实可靠、规划可追溯、人物有生命力、事件有因果、正文有创造性、失败可恢复，并让作者始终拥有最终决定权。 — `docs/LONGFORM_QUALITY.md` · 31.2 KB · `02d36fdd46fa`
...
- **卷—事件生产闭环与运行质量** — 设定、卷方向、事件链、事件完整设计、完整章链和近期详细章纲统一使用对象化闭环： — `.agents/skills/wenmi-longform-quality/references/runtime-quality-loops.md` · 7.6 KB · `81d5001e69df`
