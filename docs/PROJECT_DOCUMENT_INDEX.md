...
- **当前生效决定** — 本文只记录正在驱动当前版本的决定。 — `docs/DECISIONS.md` · 73.0 KB · `22ccafef431e`
...
- **文秘写作交接笔记（HANDOFF）** — 1. 设定页走修·五点（DEC-CURRENT-063）：① 悬疑调查乱推荐修复——根因是 blueprintSignals 把主标签/故事特质/自定义标签也计入题材包匹配，作者风格主标签选了"悬疑、推理"就激活悬疑包；已改为题材包只由分类（主要题材）和副题材决定。② 勾选持久化——设计勾选从页面内存改为按书存浏览器本地（wenmi-setting-chec — `HANDOFF.md` · 28.4 KB · `53183108a172`
