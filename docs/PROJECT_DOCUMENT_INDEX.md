...
- **文秘写作交接笔记（HANDOFF）** — 1. 设定页走修·三席撞模型修复 + 去机制文案：① 根因——book-onboarding-service 与 legacy-book-upgrade-service 的 toCreativeProfiles 都把 setting（文姬）映射到 styleeditor（GLM 5.2），与编剧B红玉撞车，提案三席校验拦截导致设定页无法召集；已改为 revi — `HANDOFF.md` · 16.5 KB · `320ab7242cc5`
