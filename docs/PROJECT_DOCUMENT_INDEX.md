...
- **当前生效决定** — 本文只记录正在驱动当前版本的决定。 — `docs/DECISIONS.md` · 137.5 KB · `aa3032f631cd`
...
- **文秘写作交接笔记（HANDOFF）** — 1. 《阵骨问天》生产20章验收进行中（DEC-CURRENT-085）：隔离账号、唯一验收书和14人团队已核对，四项核心设定完成三席独立方案、主编融合与作者确认。整份设定质检在旧生产API上连续3次稳定失败；受限管理员审计确认模型调用成功且零现金回退，但通用answer输出合同覆盖了专用verdict/summary/issues合同，旧管线又未做该工件的 — `HANDOFF.md` · 51.2 KB · `e0e69ac0a8ef`
