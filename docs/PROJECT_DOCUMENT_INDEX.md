...
- **文秘写作交接笔记（HANDOFF）** — 1. 会员四等级+算力值双倍口径+预算跟随等级+个人中心（DEC-CURRENT-077）：① 青铜20万(免费)/白银98元2000万/黄金198元5000万/钻石980元2亿，迁移 0057 重建 usermemberships，生产现有会员全部映射钻石、无会员历史账号补青铜、新注册自动发青铜（grantDefaultBronze）。② 算力值=真实to — `HANDOFF.md` · 40.7 KB · `1026c20dc876`
