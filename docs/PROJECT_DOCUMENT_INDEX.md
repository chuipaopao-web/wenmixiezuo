...
- **文秘写作交接笔记（HANDOFF）** — 1. 热修·公网限流双 BUG：① Fastify 未开 trustProxy，Caddy 反代后所有访客在限流里都是 127.0.0.1，全网共享 100 次/分钟一个桶，正常翻页（设定页批量加载）就集体 RATELIMITED——已开启 trustProxy（服务只监听 127.0.0.1，唯一能到达的是本机 Caddy，安全）。② @fastify/r — `HANDOFF.md` · 14.7 KB · `4d1fcf053225`
