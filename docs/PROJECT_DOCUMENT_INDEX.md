...
- **验收标准** — 只有当前功能、代码、迁移、测试和文档一致，且下列门禁全部有证据时才能宣布完成。测试数量不能代替真实模型长期质量证据。 — `docs/ACCEPTANCE.md` · 28.6 KB · `d1aec300b661`
...
- **当前生效决定** — 本文只记录正在驱动当前版本的决定。 — `docs/DECISIONS.md` · 37.0 KB · `9d7733c9efbe`
...
- **长篇小说创作质量与工作流规范 V2** — 本规范用于保证长篇小说在持续创作中保持事实可靠、规划可追溯、人物有生命力、事件有因果、正文有创造性、失败可恢复，并让作者始终拥有最终决定权。 — `docs/LONGFORM_QUALITY.md` · 28.5 KB · `214fdc218f79`
...
- **当前账号安全、隐私与运行运维合同** — 保护书籍隔离、作者原件、正式正文、正史、活动规划、模型凭证、本机文件、预算、任务提交、检索投影和备份。浏览器输入、导入文件、附件、模型输出、检索文本和工具响应全部视为不可信输入。 — `docs/SECURITY_AND_OPERATIONS.md` · 11.3 KB · `b56d9cf58ab8`
...
- **文秘写作当前任务** — 类型、全量测试、构建、迁移、启动、跨书隔离、任务恢复、对象化工作流和文档同步全部通过；存在重大BUG、正文覆盖、跨书污染、不可恢复任务或文档版本错配时不得宣布完成。 — `TASKS.md` · 27.4 KB · `365c6623650a`
...
- **文秘写作长篇质量审查** — name: wenmi-longform-quality — `.agents/skills/wenmi-longform-quality/SKILL.md` · 15.0 KB · `4f0b81f547d6`
