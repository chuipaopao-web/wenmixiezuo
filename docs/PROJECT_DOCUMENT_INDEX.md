...
- **当前生效决定** — 本文只记录正在驱动当前版本的决定。 — `docs/DECISIONS.md` · 98.7 KB · `247c05e86269`
...
- **文秘写作交接笔记（HANDOFF）** — 1. 预算上限提至2000万+融合/质检进度条+确认后自动收起（DEC-CURRENT-076）：老板实测设定融合全部失败+确认后页面没变化+融合无进度。① 根因=预算误卡：建书默认预算上限仍是早期 24 万 Token，老板的书已耗 21.7 万，融合预约 ~2.4 万即 BUDGETEXHAUSTED；默认值改 2000 万（book-onboardin — `HANDOFF.md` · 39.7 KB · `3bdf5c9a0990`
