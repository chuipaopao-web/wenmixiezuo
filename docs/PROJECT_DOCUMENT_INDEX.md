...
- **验收标准** — 只有当前功能、代码、迁移、测试和文档一致，且下列门禁全部有证据时才能宣布完成。测试数量不能代替真实模型长期质量证据。 — `docs/ACCEPTANCE.md` · 22.6 KB · `1d8d8f8a0aa5`
...
- **当前设计治理与审计规范** — 架构、数据、上下文、检索、Agent、生成、审查、结算或长篇质量的重要变更使用本规范。纯文案、低风险样式和明确机械修复不启动完整审查。 — `docs/DESIGN_GOVERNANCE_AUDIT.md` · 70.9 KB · `f0cb7d2b6c9e`
...
- **文秘写作当前任务** — 类型、全量测试、构建、迁移、启动、跨书隔离、任务恢复、对象化工作流和文档同步全部通过；存在重大BUG、正文覆盖、跨书污染、不可恢复任务或文档版本错配时不得宣布完成。 — `TASKS.md` · 20.1 KB · `17c4641c16e7`
