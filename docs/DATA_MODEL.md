...
### Schema 0038实际落地（DEC-108）

- `volume_plans`：独立规划卷、可选物理卷引用、上一规划卷/结算引用、状态、CAS修订和活动版本；
- `volume_plan_versions`：不可变候选全文、父版本、候选来源、冻结依赖、模板实例、作者原话引用、来源任务、内容哈希与幂等证据；
- `planning_dependencies`：上游种类、ID、版本、哈希、下游版本、有效性和失效原因；
