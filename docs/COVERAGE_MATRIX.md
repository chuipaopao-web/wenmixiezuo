...
| DEC-078 | 新书必填1—8位初始主角和20—800字故事方向；方向作为非正史软规划锚点贯穿本书资料、主编接待和规划上下文，旧书只读兼容 | `OPENING_STORY_DIRECTION_AUDIT.md`、产品/数据/Agent/记忆/API/验收/用户指南、开书合同、主编开场、规划压缩、本书资料UI与专项测试 |
...
- DEC-077增量提供已有正文的整书识别预览、作者确认、不可变前文正史、幂等检查点、混合检索索引与主编最小续写诊断包；旧稿不伪造历史点评，新写章节仍走正式生产链。确定性工程证据最高为E2，真实长篇续写的文学质量与创造性仍需E3/E4纵向盲评。
