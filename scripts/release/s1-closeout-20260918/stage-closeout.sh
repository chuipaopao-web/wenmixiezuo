...
OLD=/opt/wenmi-releases/wm-v7-20260914-151504-a7614958/source
DB=/opt/wenmi/data/database/wenmi.sqlite
exec 9>/opt/wenmi-releases/.deploy.lock
flock -n 9
test "$(cat /opt/wenmi/RELEASE_ID)" = wm-v7-20260914-151504-a7614958
...
python3 - "$ROOT" <<'PY'
import pathlib,sqlite3,sys,json,hashlib,subprocess
