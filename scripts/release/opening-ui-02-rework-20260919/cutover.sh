#!/bin/bash
# OPENING-UI-02返修 · 切换：零在途窗口→停API→迁移→逐服务切换→静态原子切换→线上验证
set -Eeuo pipefail
ROOT=/opt/wenmi-releases/wm-v7-20260919-033900-2861da92
SRC=$ROOT/source
RB=$ROOT/rollback/source
OLD=wm-v7-20260919-003800-05c82c9d
NEW=wm-v7-20260919-033900-2861da92
DB=/opt/wenmi/data/database/wenmi.sqlite
STATIC_OLD=/opt/wenmi/releases/versions/dde541476cef3f1b5492
...
test "$(readlink -f /opt/wenmi/apps)" = "/opt/wenmi-releases/wm-v7-20260919-003800-05c82c9d/source/apps"
