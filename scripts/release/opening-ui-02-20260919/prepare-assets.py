...
# OPENING-UI-02 · 静态资源并入asset-store；Caddy asset-store块已存在则只备份不重插
static_id = pathlib.Path('/opt/wenmi-releases/wm-v7-20260919-003800-05c82c9d/static-id').read_text().strip()
...
root=pathlib.Path('/opt/wenmi-releases/wm-v7-20260919-003800-05c82c9d')
