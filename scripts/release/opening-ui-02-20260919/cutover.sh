#!/bin/bash
# OPENING-UI-02 · 切换：零在途窗口→停API→迁移→逐服务切换→静态原子切换→线上验证
set -Eeuo pipefail
ROOT=/opt/wenmi-releases/wm-v7-20260919-003800-05c82c9d
SRC=$ROOT/source
RB=$ROOT/rollback/source
OLD=wm-v7-20260918-195500-758265c5
NEW=wm-v7-20260919-003800-05c82c9d
DB=/opt/wenmi/data/database/wenmi.sqlite
STATIC_OLD=/opt/wenmi/releases/versions/e6395ecdcad86db380e6
...
test "$(readlink -f /opt/wenmi/apps)" = "/opt/wenmi-releases/wm-v7-20260918-195500-758265c5/source/apps"
