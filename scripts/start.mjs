...
const userEnvironmentNames = [
  'WENMI_MODEL_MODE',
  'WENMI_ARK_CODING_PLAN_API_KEY', 'WENMI_ARK_CODING_PLAN_BASE_URL',
  'WENMI_ARK_CODING_PLAN_DEEPSEEK_MODEL', 'WENMI_ARK_CODING_PLAN_DEEPSEEK_FLASH_MODEL',
  'WENMI_ARK_CODING_PLAN_DOUBAO_MODEL', 'WENMI_ARK_CODING_PLAN_KIMI_MODEL',
  'WENMI_ARK_CODING_PLAN_KIMI_K27_MODEL',
  'WENMI_ARK_AGENT_PLAN_API_KEY', 'WENMI_ARK_AGENT_PLAN_BASE_URL',
  'WENMI_ARK_IMAGE_API_KEY', 'WENMI_ARK_IMAGE_MODEL_ID',
  'WENMI_V7_FORMALIZATION_ENABLED',
  'WENMI_PROMPT_VIEW_PASSWORD'
];
const modelCredentialNames = [
  'WENMI_ARK_CODING_PLAN_API_KEY', 'WENMI_ARK_AGENT_PLAN_API_KEY', 'WENMI_ARK_IMAGE_API_KEY'
];
