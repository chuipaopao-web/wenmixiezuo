...
import { authorApiUrl, authorAssetUrl } from './author-api-origin';
...
export function createSettingBatch(bookId: string, input: {
  designMemberKey?: string; selectedItemKeys: string[]; customItems: Array<{ label: string; prompt: string }>; authorNotes: Record<string, string>; }): Promise<SettingBatchView> {
