...
import type { V7AgentFailureClass } from '../../packages/backend/src/legacy-opening/agents/agent-failure-policy.js';
import type {
...
import {
  parseOpeningPackage,
  parseOpeningReview
} from '../../packages/backend/src/legacy-opening/opening-agent/opening-output-validation.js';
