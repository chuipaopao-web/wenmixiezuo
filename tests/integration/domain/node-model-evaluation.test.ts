...
describe('迁移0127评测表', () => {
  it('六张评测表已建立且评测登记表现金可查', () => {
    ...
    // tm2_eval_budget_ext 来自0132一次性墙钟补充迁移（067bbc24收尾决定，已复核）
    expect(tables).toEqual(['tm2_eval_budget', 'tm2_eval_budget_ext', 'tm2_eval_case', 'tm2_eval_guard_lease', 'tm2_eval_node_policy', 'tm2_eval_ranking', 'tm2_eval_reserve_journal', 'tm2_eval_run']);
  });
});
