...
// 共享夹具已抽到helpers（供S1-A持久化门禁测试复用）；此处按原名别名导入，保持既有调用不变。
import {
  DEPARTMENT_HEADERS as HEADERS,
  SettingResolver,
  settingStagePrompt,
  groupedSettingOutput,
  batchFinalReviewOutput,
  batchFinalReviewPatchOutput,
  recommendationOutput,
  registerDepartmentAuthor as register,
  createDepartmentBook as createBook,
  pollDepartmentBatch as pollBatch,
  pollDepartmentFinalReview as pollFinalReview
} from '../helpers/setting-department-fixtures.js';
