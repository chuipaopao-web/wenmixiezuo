...
describe('Schema 9升级到当前表达、知识、创作会话与设定工作区', () => {
  it('只向前追加0010—0034，保留旧书并可重复执行', () => {
